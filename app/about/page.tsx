      ...
      <Section>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-3">
          {founders.map((founder) => (
            <div key={founder.name} className="border border-white/15 p-6">
              <p className="text-xs uppercase tracking-[0.4em] text-white/60">{founder.name}</p>
              <p className="mt-2 text-white/80">{founder.role}</p>
              <p className="mt-4 text-sm text-white/60">Biography coming soon.</p>
            </div>
          ))}
        </div>
      </Section>
